...
using ColorWebsite.Api;

[assembly: PreApplicationStartMethod(typeof(SwaggerConfig), "Register")]

namespace ColorWebsite.Api
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "ColorWebsite.Api");
                        ...
                        //
                        c.IncludeXmlComments(string.Format(@"{0}\bin\ColorWebsite.Api.XML", System.AppDomain.CurrentDomain.BaseDirectory));
